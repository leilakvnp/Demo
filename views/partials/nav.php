      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/" aria-current="page" class="<?= URLs("/") ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white' ?>">Home</a>
            <a href="/about" class="<?= URLs("/about.php") ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white' ?>">About</a>
            <?php if($_SESSION['user']??false):?>
            <a href="/notes" class="<?= URLs("/notes.php") ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white' ?>">Notes</a>
            <?php endif; ?>
            <a href="/contact" class="<?= URLs("/contact.php") ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white' ?>">Contact</a>
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <?php if ($_SESSION['user'] ?? false): ?>
            ...
            <form method="POST" action="/session">
              ...
              <button class="text-white pl-3 font-xs">Log Out</button>
            <?php else: ?>

              <a href="/register" class="<?= URLs("/register.php") ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white' ?>">Register</a>
              <a href="/login" class="<?= URLs("/login.php") ? 'rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white' : 'rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white' ?>">Login</a>
            <?php endif; ?>
